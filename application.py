...
application.title = "Oil & Gas Wells"
...
# Radio -> multi
@application.callback(Output("well_types", "value"), [Input("well_type_selector", "value")])
...
# Slider -> count graph
@application.callback(Output("year_slider", "value"), [Input("count_graph", "selectedData")])
...
@application.callback(Output("individual_graph", "figure"), [Input("main_graph", "hoverData")])
